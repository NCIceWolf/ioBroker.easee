...
const easeeIds = {
  ...
  // IDs added in 2024+ firmware; sourced from pyeasee (Home Assistant
  // integration) and the Easee developer docs. 233 + 234 are observed
  // in production but currently undocumented upstream and left out.
  219: ".status.fatalErrorCode",
  220: ".status.lteRSRP",
  221: ".status.lteSINR",
  222: ".status.lteRSRQ",
  223: ".status.chargingSessionStart",
  230: ".status.eqAvailableCurrentP1",
  231: ".status.eqAvailableCurrentP2",
  232: ".status.eqAvailableCurrentP3",
  240: ".status.diagnosticsString",
  241: ".config.wiFiMACAddress",
  250: ".status.connectedToCloud",
